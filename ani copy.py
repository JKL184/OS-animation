...
#FCFS SCENES
fc_sprites = []
fc_sprites.append(pygame.image.load("FCFS images\scene1\scene1.png"))
fc_sprites.append(pygame.image.load("FCFS images\scene2\scene2.png"))
fc_sprites.append(pygame.image.load("FCFS images\scene3\scene3p1.png"))
fc_sprites.append(pygame.image.load("FCFS images\scene3\scene3p2.png"))
fc_sprites.append(pygame.image.load("FCFS images\scene3\scene3p3.png"))
fc_sprites.append(pygame.image.load("FCFS images\scene3\scene3p4.png"))
fc_sprites.append(pygame.image.load("FCFS images\scene4\scene4p1.png"))
fc_sprites.append(pygame.image.load("FCFS images\scene4\scene4p2.png"))
fc_sprites.append(pygame.image.load("FCFS images\scene5\scene5p1.png"))
fc_sprites.append(pygame.image.load("FCFS images\scene5\scene5p2.png"))
...
sj_scene = Scenes(100,150,sj_sprites,0.05)
